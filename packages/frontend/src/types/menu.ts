...
export type MenuLink = { type: 'link', to: string, text: string, icon?: string, suffixIcon?: string, indicate?: boolean, avatar?: Misskey.entities.User };
export type MenuA = { type: 'a', href: string, target?: string, download?: string, text: string, icon?: string, suffixIcon?: string, indicate?: boolean };
...
export type MenuButton = { type?: 'button', text: string, icon?: string, suffixIcon?: string, indicate?: boolean, danger?: boolean, active?: boolean | ComputedRef<boolean>, avatar?: Misskey.entities.User; action: MenuAction };
