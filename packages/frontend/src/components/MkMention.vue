...
import { avatarsMap, loadUsers, usernameAndHostToIdMap, usernameAndHostToKey } from '@/utility/avatars.js';
...
const avatarUrl = computed(() => prefer.s.disableShowingAnimatedImages || prefer.s.dataSaver.avatar ? getStaticImageUrl(baseUrl.value) : baseUrl.value);
