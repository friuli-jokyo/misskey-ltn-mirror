...
>
	...
	<article v-else :class="$style.article" @contextmenu.stop="onContextmenu">
		...
		<MkAvatar v-if="!appearNote.anonymouslySendToUser" :class="[$style.avatar, prefer.s.useStickyIcons ? $style.useSticky : null]" :user="userOf(appearNote)" :link="!mock && !appearNote.anonymousChannelUsername" :preview="!mock"/>
		<div :class="$style.main">
			...
			<div style="container-type: inline-size;">
				...
				<div v-show="appearNote.cw == null || showContent" :class="[{ [$style.contentCollapsed]: collapsed }]">
					...
					<div v-if="appearNote.renoteId" :class="$style.quote"><MkNoteSimple :note="appearNote?.renote ?? null" :class="$style.quoteNote" quote/></div>
			...
			<MkReactionsViewer
				...
				:noteId="appearNote.id"
				:noteAnonymousChannelUsername="appearNote.anonymousChannelUsername"
				:maxNumber="16"
...
const renoteCollapsed = ref(
	prefer.s.collapseRenotes && (isRenote || (note as any).promoted) && (
...
provide(DI.mfmEmojiReactCallback, (reaction) => {
	...
	const confirm = appearNote.anonymousChannelUsername
		? os.confirm({
				type: 'warning',
...
async function react() {
	...
	showMovedDialog();
	if (appearNote.anonymousChannelUsername) {
