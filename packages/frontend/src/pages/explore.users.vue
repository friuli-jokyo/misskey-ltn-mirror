...
type UsersEndpointWithExcludePinned = {
	req: Misskey.Endpoints['users']['req'] & { excludePinned?: boolean };
	res: Misskey.Endpoints['users']['res'];
};
...
const popularUsersPaginator = markRaw(new Paginator<'users', UsersEndpointWithExcludePinned>('users', {
	limit: 10,
	noPaging: true,
	params: {
		state: 'alive',
...
const popularUsersFPaginator = markRaw(new Paginator<'users', UsersEndpointWithExcludePinned>('users', {
	limit: 10,
	noPaging: true,
	params: {
		state: 'alive',
