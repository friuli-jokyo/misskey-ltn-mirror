	...
	<div class="_gaps_m">
		...
		<div class="_gaps_s">
			...
			<SearchMarker v-slot="slotProps" :keywords="['timeline', 'note']">
				...
				<SearchMarker :keywords="['footer', 'action', 'translate', 'show']">
					<MkPreferenceContainer k="showTranslateButtonInNoteFooter">
						<MkSwitch v-model="showTranslateButtonInNoteFooter">
							<template #label><SearchLabel>{{ i18n.ts.showTranslateButtonInNoteFooter }}</SearchLabel></template>
						</MkSwitch>
					</MkPreferenceContainer>
				</SearchMarker>

				<SearchMarker :keywords="['renote', 'collapse']">
					<MkPreferenceContainer k="collapseRenotes">
						<MkSwitch v-model="collapseRenotes">
							<template #label><SearchLabel>{{ i18n.ts.collapseRenotes }}</SearchLabel></template>
						</MkSwitch>
								...
								<SearchMarker :keywords="['timeline', 'reply', 'show']">
									<MkPreferenceContainer k="showTimelineReplies">
										<MkSwitch v-model="showTimelineReplies">
											<template #label><SearchLabel>{{ i18n.ts.flagShowTimelineReplies }}</SearchLabel></template>
											<template #caption><SearchText>{{ i18n.ts.flagShowTimelineRepliesDescription }}</SearchText></template>
										</MkSwitch>
									</MkPreferenceContainer>
								</SearchMarker>

								<SearchMarker :keywords="['neighbor', 'local', 'timeline']">
									<MkPreferenceContainer k="localNeighborNotes">
										<MkSwitch v-model="localNeighborNotes">
											<template #label><SearchLabel>{{ i18n.ts.localNeighborNotes }}</SearchLabel></template>
										</MkSwitch>
									</MkPreferenceContainer>
								</SearchMarker>

								<SearchMarker :keywords="['neighbor', 'global', 'timeline']">
									<MkPreferenceContainer k="globalNeighborNotes">
										<MkSwitch v-model="globalNeighborNotes">
											<template #label><SearchLabel>{{ i18n.ts.globalNeighborNotes }}</SearchLabel></template>
										</MkSwitch>
									</MkPreferenceContainer>
								</SearchMarker>
							</div>
							...
							<SearchMarker :keywords="['reaction', 'size', 'adaptive']">
								<MkPreferenceContainer k="adaptiveReactionsDisplaySize">
									<MkSwitch v-model="adaptiveReactionsDisplaySize">
										<template #label><SearchLabel>{{ i18n.ts.adaptiveReactionsDisplaySize }}</SearchLabel></template>
									</MkSwitch>
								</MkPreferenceContainer>
							</SearchMarker>

							<SearchMarker :keywords="['reaction', 'avatar', 'user']">
								<MkPreferenceContainer k="showReactedUserAvatars">
									<MkSwitch v-model="showReactedUserAvatars">
										<template #label><SearchLabel>{{ i18n.ts.showReactedUserAvatars }}</SearchLabel></template>
									</MkSwitch>
								</MkPreferenceContainer>
							</SearchMarker>
				...
				<MkFolder :defaultOpen="slotProps.isParentOfTarget">
					...
					<div class="_gaps_m">
						<div class="_gaps_s">
							...
							<SearchMarker :keywords="['visibility', 'dial', 'show']">
								<MkPreferenceContainer k="showNoteVisibilityDial">
									<MkSwitch v-model="showNoteVisibilityDial">
										<template #label><SearchLabel>{{ i18n.ts.showNoteVisibilityDial }}</SearchLabel></template>
									</MkSwitch>
								</MkPreferenceContainer>
							</SearchMarker>

							<SearchMarker :keywords="['channel', 'post', 'form']">
								<MkPreferenceContainer k="postFormOnChannelShouldPostToChannel">
									<MkSwitch v-model="postFormOnChannelShouldPostToChannel">
										<template #label><SearchLabel>{{ i18n.ts.postFormOnChannelShouldPostToChannel }}</SearchLabel></template>
									</MkSwitch>
								</MkPreferenceContainer>
							</SearchMarker>

							<SearchMarker :keywords="['cw', 'auto', 'open']">
								<MkPreferenceContainer k="autoOpenCws">
									<MkTextarea v-model="autoOpenCwsText">
										<template #label><SearchLabel>{{ i18n.ts.autoOpenCWs }}</SearchLabel></template>
									</MkTextarea>
								</MkPreferenceContainer>
							</SearchMarker>
...
const showTranslateButtonInNoteFooter = prefer.model('showTranslateButtonInNoteFooter');
...
const showNoteVisibilityDial = prefer.model('showNoteVisibilityDial');
const postFormOnChannelShouldPostToChannel = prefer.model('postFormOnChannelShouldPostToChannel');
const autoOpenCws = prefer.model('autoOpenCws');
const showTimelineReplies = prefer.model('showTimelineReplies');
...
const adaptiveReactionsDisplaySize = prefer.model('adaptiveReactionsDisplaySize');
const showReactedUserAvatars = prefer.model('showReactedUserAvatars');
const limitWidthOfReaction = prefer.model('limitWidthOfReaction');
const squareAvatars = prefer.model('squareAvatars');
const localNeighborNotes = prefer.model('localNeighborNotes');
const globalNeighborNotes = prefer.model('globalNeighborNotes');
...
const autoOpenCwsText = computed({
	get() {
		return autoOpenCws.value.join('\n');
	},
	set(value: string) {
		prefer.commit('autoOpenCws', value.split('\n').filter(v => v));
	},
});
