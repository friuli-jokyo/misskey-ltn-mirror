...
const typeDef = [
	...
	{ label: i18n.ts._role._condition.isEmailVerified, value: 'isEmailVerified' },
	{ label: i18n.ts._role._condition.isTwoFactorEnabled, value: 'isTwoFactorEnabled' },
	{ label: i18n.ts._role._condition.isPasswordLessLoginEnabled, value: 'isPasswordLessLoginEnabled' },
