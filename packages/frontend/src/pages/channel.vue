	...
	<div class="_spacer" style="--MI_SPACER-w: 700px;">
		<div v-if="channel && tab === 'overview'" class="_gaps">
			...
			<MkFoldableSection :expanded="false">
				...
				<MkSuspense v-slot="{ result: info }" :p="initInfo">
					<FormSection>
						<FormSplit>
							<MkKeyValue>
							...
							<MkKeyValue>
								...
								<template #value>{{ channel.anonymousStrategy === 'daily' ? i18n.ts.daily : channel.anonymousStrategy === 'weekly' ? i18n.ts.weekly : channel.anonymousStrategy === 'monthly' ? i18n.ts.monthly : channel.anonymousStrategy === 'yearly' ? i18n.ts.yearly : channel.anonymousStrategy === 'manual' ? i18n.ts.manual : i18n.ts.none }}</template>
							</MkKeyValue>
							<MkKeyValue>
...
watch(() => props.channelId, async () => {
	...
	miLocalStorage.setItem(`channel:${props.channelId}`, JSON.stringify(_channel));
}, { immediate: true });
