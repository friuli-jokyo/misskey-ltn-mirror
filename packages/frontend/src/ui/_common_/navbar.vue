	...
	<div :class="$style.body">
		<div :class="$style.top">
			<button v-tooltip.noDelay.right="instance.name ?? i18n.ts.instance" class="_button" :class="$style.instance" @click="openInstanceMenu">
				<img :src="instance.iconUrl || '/favicon.png'" alt="" :class="$style.instanceIcon" style="view-transition-name: navbar-serverIcon;"/>
			</button>
		...
		<div :class="$style.middle">
			...
			<MkSettingSuggestion :class="$style.info"/>
		</div>
		...
		<button v-tooltip.noDelay.right="i18n.ts.note" class="_button" :class="[$style.post]" data-cy-open-post-form @click="() => { os.postButtonTriggered(mainRouter.current); }">
...
import { $i } from '@/i.js';
import MkSettingSuggestion from '@/components/MkSettingSuggestion.vue';
