	...
	<div :class="$style.body">
		<div>
			<button v-click-anime :class="[$style.item, $style.instance]" class="_button" @click="openInstanceMenu">
				<img :class="$style.instanceIcon" :src="instance.iconUrl ?? '/favicon.png'" draggable="false"/>
			</button>
		...
		<div :class="$style.right">
			...
			</MkA>		<MkSettingSuggestion :class="$style.info"/>			<button v-if="$i" v-click-anime :class="[$style.item, $style.account]" class="_button" @click="openAccountMenu">
				<MkAvatar :user="$i" :class="$style.avatar"/><MkAcct :class="$style.acct" :user="$i"/>
			</button>
		<div :class="$style.post" @click="os.postButtonTriggered(mainRouter.current)">
